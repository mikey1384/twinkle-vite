...
export const chatFormClass = css`
  ...
  > footer { position: sticky; bottom: 0; z-index: 2; display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 8px; padding: 12px 20px; border-top: 1px solid #e2e8f0; background: #f8fafc; }
  ...
  .setting { padding: 14px; border: 1px solid #dce3ed; border-radius: 12px; background: #f8fafc; }
  ...
  .choice { display: flex; flex-direction: column; align-items: flex-start; gap: 8px; min-height: 150px; padding: 18px; border: 1px solid #d3dce9; border-radius: 14px; background: #f8fafc; color: #253247; text-align: left; font: inherit; cursor: pointer; }
  .choice > svg { font-size: 26px; color: var(--theme-bg, #418ceb); }
  .choice strong { font-size: 16px; }
  .choice span { color: #526176; font-size: 14px; }
  .choice:hover { background: #edf2f8; border-color: #94a3b8; }
