export const getThemeStyles = (theme: string, opacity?: number) => {
  ...
  const themeColors: Record<string, any> = {
    logoBlue: {
      ...
      border: `rgba(179, 194, 255, ${appliedOpacity})`
    },
    green: {
      ...
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
      border: `rgba(183, 205, 183, ${appliedOpacity})`
    },
    orange: {
      ...
      border: `rgba(255, 220, 160, ${appliedOpacity})`
    },
    rose: {
      ...
      border: `rgba(255, 180, 200, ${appliedOpacity})`
    },
    pink: {
      ...
      border: `rgba(255, 215, 225, ${appliedOpacity})`
    },
    purple: {
      ...
      border: `rgba(217, 204, 255, ${appliedOpacity})`
    },
    black: {
      ...
      border: `rgba(192, 192, 192, ${appliedOpacity})`
    },
    red: {
      ...
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
      border: `rgba(255, 164, 164, ${appliedOpacity})`
    },
    darkBlue: {
      ...
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
      border: `rgba(184, 192, 255, ${appliedOpacity})`
    },
    vantaBlack: {
      bg: `rgba(232, 232, 232, ${fadedOpacity})`,
      hoverBg: `rgba(232, 232, 232, ${appliedOpacity})`,
    ...
    gold: {
      ...
      border: `rgba(209, 170, 0, ${appliedOpacity})`
    }
  };
  return (
    themeColors[theme] || {
      ...
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
      border: `rgba(215, 215, 215, ${appliedOpacity})`
    }
  );
};
