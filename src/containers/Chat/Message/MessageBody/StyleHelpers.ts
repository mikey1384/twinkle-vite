export const getThemeStyles = (theme: string, opacity?: number) => {
  ...
  const themeColors: Record<string, any> = {
    logoBlue: {
      ...
      hoverBg: `rgba(209, 224, 255, ${appliedOpacity})`,
    ...
    green: {
      ...
      hoverBg: `rgba(213, 235, 213, ${appliedOpacity})`,
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
    ...
    orange: {
      ...
      hoverBg: `rgba(255, 236, 204, ${appliedOpacity})`,
    ...
    rose: {
      ...
      hoverBg: `rgba(255, 210, 220, ${appliedOpacity})`,
    ...
    pink: {
      ...
      hoverBg: `rgba(255, 225, 235, ${appliedOpacity})`,
    ...
    purple: {
      ...
      hoverBg: `rgba(227, 214, 255, ${appliedOpacity})`,
    ...
    black: {
      ...
      hoverBg: `rgba(212, 212, 212, ${appliedOpacity})`,
    ...
    red: {
      ...
      hoverBg: `rgba(255, 184, 184, ${appliedOpacity})`,
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
    ...
    darkBlue: {
      ...
      hoverBg: `rgba(204, 212, 255, ${appliedOpacity})`,
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
    ...
    gold: {
      ...
      hoverBg: `rgba(255, 245, 204, ${appliedOpacity})`,
  ...
  return (
    themeColors[theme] || {
      ...
      hoverBg: `rgba(235, 235, 235, ${appliedOpacity})`,
      text: `rgba(50, 50, 50, ${appliedOpacity})`,
