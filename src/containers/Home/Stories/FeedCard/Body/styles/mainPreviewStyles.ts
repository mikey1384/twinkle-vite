...
export const mainPreviewStyles = `
  ...
  .home-feed-card__subject-preview--root-compact .home-feed-card__subject-description {
    ...
    border-color: ${Color.gold(0.26)};
    border-radius: 0.68rem;
    background: ${Color.ivory()};
    font-size: max(1.24rem, 12.4px);
    line-height: 1.22;
  }
  ...
  .home-feed-card__build-copy {
    display: flex;
    flex-direction: column;
    gap: 0.45rem;
    min-width: 0;
  }
  .home-feed-card__build-copy p,
  ...
  .home-feed-card__build-actions button {
    appearance: none;
    ...
    background: ${Color.logoBlue(0.11)};
    color: ${Color.logoBlue()};
    font: inherit;
    font-size: 1.1rem;
    font-weight: 800;
  ...
  .home-feed-card__build-actions button.primary {
    border-color: ${Color.logoBlue()};
    background: ${Color.logoBlue()};
    color: #fff;
  }
  .home-feed-card__build-thumb {
    position: relative;
    min-width: 0;
    height: 100%;
    overflow: hidden;
  ...
  .home-feed-card__build-thumb img {
    width: 100%;
    height: 100%;
    object-fit: cover;
  }
  .home-feed-card__build-thumb-toolbar {
    position: absolute;
    top: 0;
    right: 0;
    left: 0;
  ...
  .home-feed-card__build-thumb-toolbar span {
    width: 0.42rem;
    height: 0.42rem;
    border-radius: 999px;
