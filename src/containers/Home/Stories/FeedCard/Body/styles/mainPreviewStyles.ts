...
export const mainPreviewStyles = `
  ...
  .home-feed-card__panel-preview--text-compact .home-feed-card__text-copy {
    ...
    @media (min-width: ${desktopMinWidth}) {
      .home-feed-card__rich-embed-preview--with-text
        .home-feed-card__rich-embed-image.home-feed-card__rich-embed-internal--ai-card
        .compact-ai-card-preview {
        grid-template-columns: minmax(7.2rem, 0.88fr) minmax(0, 1.12fr);
      ...
      .home-feed-card__rich-embed-preview--with-text
        ...
        width: clamp(7.1rem, 35cqw, 9.2rem);
        height: clamp(9.9rem, 49cqw, 12.8rem);
        max-width: 100%;
  ...
  .home-feed-card__subject-main--with-embed:not(
      .home-feed-card__subject-main--with-attachment
    ) {
    display: flex;
    flex-direction: column;
  ...
  .home-feed-card__subject-embed-preview:has([data-compact-comment-embed]) {
    flex: 0 0 auto;
    align-self: stretch;
    overflow: visible;
    border: 0;
